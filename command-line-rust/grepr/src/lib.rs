...
pub fn get_args() -> MyResult<Config> {
    let mut matches = Command::new("grepr")
        .version("0.1.0")
            ...
            Ok(filename) => match open(&filename) {
                ...
                Ok(file) => {
                    ...
                    match matches {
                        ...
                        Ok(matches) => {
                            if config.count {
                                print(&filename, &format!("{}", matches.len()));
                            } else {
                                for line in &matches {
                                    print(&filename, line);
                                }
...
mod tests {
    ...
    #[test]
    fn test_find_files() {
        // Verify that the function finds a file know to exit
        ...
        // Verify the function recursively to find four files in the directory
